 ...
 */
final class Version20200708074223 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE partner (id INT AUTO_INCREMENT NOT NULL, poster_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, decription LONGTEXT NOT NULL, date DATETIME NOT NULL, INDEX IDX_312B3E165BB66C05 (poster_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
